    ...
    <div class="container">
        ...
        <div class="row align-items-start">
            ...
            <div class="d-flex position-relative">
                ...
                <div>
                <h5 class="mt-0">¿Necesitas ver el estado de tu Reclamo?</h5>
                <p>Si necesitas conocer el estado del reclamo, podes verificar el mismo desde tu propia casa a través de la siguiente opción</p>
                <a href="./pages/registros.html" class="btn btn-primary">Ver tus Reclamos</a>
                </div>
